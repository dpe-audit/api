...
enum TypeFermeture: string
{
    ...
    case VOLETS_ROULANTS_PVC_BOIS_EPAISSEUR_LTE_12MM = 'volets_roulants_pvc_bois_epaisseur_lte_12_mm';
    case VOLETS_ROULANTS_PVC_BOIS_EPAISSEUR_GT_12MM = 'volets_roulants_pvc_bois_epaisseur_gt_12_mm';
    case PERSIENNE_COULISSANTE_EPAISSEUR_LTE_22MM = 'persienne_coulissante_epaisseur_lte_22_mm';
    case PERSIENNE_COULISSANTE_EPAISSEUR_GT_22MM = 'persienne_coulissante_epaisseur_gt_22_mm';
    case VOLET_BATTANT_PVC_BOIS_EPAISSEUR_LTE_22MM = 'volet_battant_pvc_bois_epaisseur_lte_22_mm';
    case VOLET_BATTANT_PVC_BOIS_EPAISSEUR_GT_22MM = 'volet_battant_pvc_bois_epaisseur_gt_22_mm';
