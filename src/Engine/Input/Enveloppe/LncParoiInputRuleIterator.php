...
/**
 * @extends RuleIterator<LncParoiInput>
 */
abstract class LncParoiInputRuleIterator extends RuleIterator
{
    /**
     * @inheritDoc
     */
    public function collection(): array
    {
        ...
        foreach ($this->data()->enveloppe->locaux_non_chauffes as $local_non_chauffe) {
            ...
            $collection = array_merge($collection, $local_non_chauffe->parois);
        }
        return $collection;
    }
