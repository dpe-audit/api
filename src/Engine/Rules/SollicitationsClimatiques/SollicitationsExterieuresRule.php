...
namespace App\Engine\Rules\SollicitationsClimatiques;
...
final class SollicitationsExterieuresRule extends Rule
{
    ...
    public function zone_climatique(): ZoneClimatique
    {
        return $this->get('zone_climatique', function (): ZoneClimatique {
            return ZoneClimatique::from_code_departement($this->data()->batiment->code_departement());
        });
    }
    ...
    public function parois_anciennes_lourdes(): bool
    {
        return $this->get('parois_anciennes_lourdes', function () {
            return $this->data()->batiment->materiaux_anciens() && \in_array($this->data()->enveloppe->inertie(), [
                Inertie::TRES_LOURDE,
                Inertie::LOURDE,
            ]);
        });
