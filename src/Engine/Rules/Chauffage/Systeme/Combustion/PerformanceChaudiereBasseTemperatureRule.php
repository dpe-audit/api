...
final class PerformanceChaudiereBasseTemperatureRule extends PerformanceChaudiereRule
{
    public static function supports(Systeme $entity): bool
    {
        ...
        $match = $match && ModeCombustion::BASSE_TEMPERATURE === $entity->generateur()->signaletique()->mode_combustion;
        return $match;
    }
